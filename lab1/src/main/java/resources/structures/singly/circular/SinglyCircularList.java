package resources.structures.singly.circular;

import java.util.Iterator;
import java.util.logging.Level;
import java.util.logging.Logger;

import resources.structures.interfaces.linkedlist.LinkedListInterface;
import resources.structures.interfaces.node.NodeInterface;
import resources.structures.nodes.SinglyLinkedNode;

public class SinglyCircularList<T> implements LinkedListInterface<T>{
