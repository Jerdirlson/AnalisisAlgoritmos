package upb.resources.structures.doublee.circular;

import java.util.Iterator;
import java.util.logging.Level;
import java.util.logging.Logger;

import upb.resources.structures.interfaces.linkedlist.LinkedListInterface;
import upb.resources.structures.interfaces.node.NodeInterface;
import upb.resources.structures.nodes.DoubleLinkedNode;

public class DoubleCircularList<T> implements LinkedListInterface<T>{
